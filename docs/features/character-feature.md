...
Excluir personagem deve exigir confirmação. Editar personagem deve reutilizar o fluxo de criação com dados preenchidos. Dias de sobrevivência e zumbis abatidos devem aceitar apenas números não negativos. Habilidades devem usar as mesmas seções recolhíveis do fluxo de criação e edição.
